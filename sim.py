...
for i in range(step_num):
    ...
    [speed_es_output, speed_high_pass_output, speed_low_pass_output, 
        speed_m2_sqrt, speed_gradient, speed_setpoint] = speed_extremum_seeking.update(cost-cost_init)
    [sideslip_es_output, sideslip_high_pass_output, sideslip_low_pass_output, 
        sideslip_m2_sqrt, sideslip_gradient, sideslip_setpoint] = sideslip_extremum_seeking.update(cost-cost_init)
