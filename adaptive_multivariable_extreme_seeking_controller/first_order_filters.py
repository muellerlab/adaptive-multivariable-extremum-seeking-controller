...
class High_pass_filter_first_order:
    def __init__(self, sampling_period, cutoff_frequency_rad_per_s, initial_input, initial_output):
        self.dt = sampling_period
        self.wc = cutoff_frequency_rad_per_s
        self.a1 = self.dt * self.wc + 2 #output coefficient
        self.b1 = self.dt * self.wc - 2 #input coefficient
        self.u_prev = initial_input #prior input
        self.y_prev = initial_output #prior output
        return
